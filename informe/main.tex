...
United States Geological Survey (USGS), dentro de radios de 50~km y 200~km medidos
...
\begin{itemize}
    ...
    \item \textbf{200 km}: catálogo regional, que permite capturar fuentes
          ...
          amenaza sísmica de Neiva.
    \end{itemize}

La Figura~\ref{fig:mapa_zona} muestra el punto de referencia junto con ambos
radios de búsqueda, superpuestos sobre los epicentros del catálogo del SGC a
200~km, coloreados por magnitud. Se aprecia una alineación de sismicidad de
suroeste a noreste, consistente con el sistema de fallas regional de la zona
(Algeciras--Suaza), además de un cúmulo de sismicidad más profunda hacia el
occidente, asociado a la zona de subducción.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{../figuras/mapa_zona_estudio.png}
    \caption{Zona de estudio: punto de referencia en Neiva, radios de búsqueda
    de 50 y 200~km, y epicentros del catálogo SGC (200~km) coloreados por
    magnitud.}
    \label{fig:mapa_zona}
\end{figure}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lll}
        ...
        Radios & 50 km y 200 km & 50 km y 200 km \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{llrrr}
        ...
        \midrule
        SGC  & 50 km  & 2\,374  & 0.7 & 5.0 \\
        SGC  & 200 km & 45\,201 & 0.1 & 7.1 \\
        USGS & 50 km  & 20      & 3.4 & 5.5 \\
        USGS & 200 km & 470     & 0.0 & 7.3 \\
        \bottomrule
    \end{tabular}
\end{table}
...
($M \geq 4$), ambos catálogos reportan cantidades de eventos comparables entre
sí, lo que es consistente con esta explicación.
