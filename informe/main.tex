...
Oriental; el radio de 200~km alcanza ciudades como Cali, Ibagué, Bogotá y
Popayán, y se extiende hasta la zona de subducción del Pacífico.
...
\begin{figure}[htbp]
    ...
    Santander) y radios de búsqueda de 50 y 200~km. Imagen satelital: Google
    Earth.}
    \label{fig:mapa_zona}
\end{figure}
...
200~km, coloreados por magnitud y diferenciados por fuente (círculos para
...
\begin{figure}[htbp]
    ...
    200~km alrededor de Neiva, coloreados por magnitud y diferenciados por
    fuente.}
